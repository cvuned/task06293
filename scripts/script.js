...
if(grupoAsignado<2){ // Instrucciones para los grupos A1 y A2: 
	...
	var arrayInstruc=[ // Instrucciones para los grupos B1 y B2: 
		...
		//5: Instrucciones 2.c // TFK requiere cambio // TFK Comprobar - modificada
		"<p><h3 class=\"titulo\">Instrucciones</h3>A continuación te informaremos de si el paciente superó la crisis EXISTENCIAL!!! TFK.</p><table style=\"text-align: center; align-content: center; border:"
		+ " 0px; width: 100%;\"><tr><td><img src=\""+FaseTest.ImagenSindrome+"\" width=\"150px\"></td><td><img src=\""+FaseTest.ImagenSano+"\" width=\"150px\"></td></tr><tr><td>Paciente enfermo</td><td>Paciente curado</td></tr></table><p> Después de darte esa información, se te presentará la ficha del siguiente paciente.<br> Cuando hayas visto a un cierto número de pacientes pasaremos a la siguiente fase.</p>",
